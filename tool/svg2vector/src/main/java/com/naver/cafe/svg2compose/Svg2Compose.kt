package com.naver.cafe.svg2compose
...
import androidx.compose.material.icons.generator.IconGroupGenerator
...
fun main() {
    val iconTest = File("./tool/svg2vector/src/main/resources")
    val src = File("./cds/src/main/java").apply { mkdirs() }
    svg2compose(
        applicationIconPackage = "com.naver.cafe.compose.icons",
        accessorName = "icon",
...
private fun drawableTempDirectory(): File = createTempDirectory("svg2compose").toFile()
